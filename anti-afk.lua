local Artillery = Instance.new("ScreenGui")
...
Artillery.Parent = game.CoreGui
Artillery.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Main.Name = "Main"
Main.Parent = Artillery
...
Credits.Text = "Made by kevlar#1871"
